...
public class Tetromino_Bar  extends Mino {
    ...
    public void setXY(int x, int y){
        ...
        b[0].setX(x);
        b[0].setY(y);
        b[1].setX(b[0].getXPostion() - Block.SIZE);
        b[1].setY(b[0].getYPostion());
        b[2].setX(b[0].getXPostion() + Block.SIZE);
        b[2].setY(b[0].getYPostion());
        b[3].setX(b[0].getXPostion() + Block.SIZE * 2);
    ...
    public void getDirection1(){
        ...
        tempB[3].setX(b[0].getXPostion() + Block.SIZE * 2);
    ...
    public void getDirection2(){
        ...
        tempB[3].setY(b[0].getYPostion() + Block.SIZE * 2);
